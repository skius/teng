...
pub trait Animation: Debug {
    ...
    fn render(&self, screen_base: (usize, usize), current_time: Instant, renderer: &mut dyn Renderer) -> bool;
}
...
impl Animation for CharAnimationSequence {
    fn render(&self, (x, y): (usize, usize), current_time: Instant, mut renderer: &mut dyn Renderer) -> bool {
